        ...
        import {
            ...
            inspectCloudHealth,
            inspectIndexedDbHealth,
            inspectServiceWorkerHealth,
            invalidateCloudHealthSnapshot,
            isCloudHealthSnapshotFresh,
            refreshCloudAccountUI,
            rememberCloudSyncSuccess,
...
async function refreshUserPlaylistLibrary() {
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            // The playlist view writes currentIndex, so it needs a setter as well
            // as getters; a getter alone cannot be an assignment target.
            configurePlaylistView({
                dom,
            ...
            // db and storageState are mutable and assigned later (initDatabase sets
            // db), so they arrive as getters; a snapshot would read null forever.
            configureCloudUi({
                CLOUD_OUTBOX_STORE,
                PLAYLIST_HISTORY_STORE,
                cloudPendingOperationLabel,
                formatCloudPendingUpdatedAt,
                forgetCloudSyncError,
                getConfiguredCloud,
                getDb: () => db,
