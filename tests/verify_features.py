...
HEALTH_CHECK_E2E = (ROOT / "tests" / "e2e" / "cloud-health-check.spec.mjs").read_text(encoding="utf-8")
...
require("cplayer5-v79-search-pointer-pagination" in SW, "service worker cache version is not updated")
...
require("toCloudPlaylistInput" in CLOUD_SYNC and "diffPlaylistContent" in CLOUD_SYNC and "p_expected_version" in CLOUD_SYNC,
...
for snippet in [
    "本机同步健康检查只读",
    "getCloudHealthReport",
    "readStorageFingerprint",
    "current_queue",
    "publishableKey",
]:
