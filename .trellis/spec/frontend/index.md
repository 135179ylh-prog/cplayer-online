...
| Guide | Scope | Status |
| --- | --- | --- |
| [Quality Guidelines](./quality-guidelines.md) | Release gate, browser regression, main app module loading, responsive accessibility, PWA install/update checks, deterministic media lifecycle, playback metadata, and API configuration | Maintained |
